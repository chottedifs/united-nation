...
@section('content')
            ...
            <div class="row mb-4">
                @foreach ($story as $stories)
                    <div class="col-sm-12 col-md-6">
                        <a data-bs-toggle="modal" data-bs-target="#story-{{ $stories->Story->id }}"
                            ...
                            <div class="card" data-aos="fade-right">
                                <div class="card-body p-0">
                                    ...
                                    <span class="read-more read-more d-none d-sm-block d-md-block"><img
                                            src="{{ asset('template/united-nation/assets/images/motif-read.svg') }}"
                                            alt="motif-read" class="me-2" width="20">Read more</span>
                                    </p>
                                </div>
                            </div>
                        </a>
    ...
    <!-- Modal Story -->
    @foreach ($story as $stories)
        <div class="modal fade" id="story-{{ $stories->Story->id }}" aria-hidden="true" aria-labelledby="story-1"
            tabindex="-1">
                    ...
                    <div class="modal-body pt-0 pb-0">
                        <div class="row">
                            ...
                            <div class="col-lg-7 bg-color-bluedark bg-box-story">
                                <button type="button" class="btn-close me-3 mb-3 my-3 bg-white" data-bs-dismiss="modal"
