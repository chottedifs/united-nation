            ...
            <div class="row mb-5">
                @foreach ($storyUp as $storyUps)
                    <div class="col-sm-12 col-md-6">
                        <a data-bs-toggle="modal" data-bs-target="#storyUp-{{ $storyUps->StoryUp->id }}"
                                ...
                                <div class="card-body p-0">
                                    ...
                                    <p class="text-card-story mt-5">
                                        <img src="{{ asset('template/united-nation/assets/images/motif-read-blue.svg') }}"
                                            alt="motif-read" class="me-2" width="40">{{ $storyUps->StoryUp->name }}
                                    </p>
                                </div>
                            </div>
                        </a>
                    ...
                    {{-- Modal --}}
                    <div class="modal fade" id="storyUp-{{ $storyUps->StoryUp->id }}" aria-hidden="true"
                        aria-labelledby="story-1" tabindex="-1">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7">
                                            <button type="button" class="btn-close me-3 mb-3 my-3 bg-white"
                                                data-bs-dismiss="modal" aria-label="Close" style="float: right;"></button>
                                            <p class="text-content" style="font-size: 18px; padding: 40px 20px 40px 20px;">
                                                <span class="text-modal-story"><img
                                                        src="{{ asset('template/united-nation/assets/images/motif-read-blue.svg') }}"
                                                        alt="motif-read" class="me-2"
                                                        width="40">{{ $storyUps->StoryUp->name }}</span> <br>
                                                <span
                                                    class="text-submodal-story">{{ $storyUps->StoryUp->position }}</span><br><br>
        ...
        <div class="container">
            <div class="row mb-5">
                @foreach ($storyMiddle as $storyMiddle)
                    <div class="col-sm-12 col-md-6">
                        <a data-bs-toggle="modal" data-bs-target="#storyMiddle-{{ $storyMiddle->StoryMiddle->id }}"
                            style="cursor: pointer;">
                            <div class="card" data-aos="fade-right">
                                <div class="card-body p-0">
                                    ...
                                    <p class="text-card-story mt-5">
                                        <img src="{{ asset('template/united-nation/assets/images/motif-read-blue.svg') }}"
                                            alt="motif-read" class="me-2"
                                            width="40">{{ $storyMiddle->StoryMiddle->name }}
                                    </p>
                                </div>
                            </div>
                        </a>
                    ...
                    {{-- Modal --}}
                    <div class="modal fade" id="storyMiddle-{{ $storyMiddle->StoryMiddle->id }}" aria-hidden="true"
                        aria-labelledby="story-1" tabindex="-1">
                        <div class="modal-dialog modal-fullscreen">
                            <div class="modal-content">
                                <div class="modal-body pt-0 pb-0">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7">
                                            ...
                                            <p class="text-content"
                                                style="font-size: 18px; padding: 40px 20px 40px 20px;">
                                                <span class="text-modal-story"><img
                                                        src="{{ asset('template/united-nation/assets/images/motif-read-blue.svg') }}"
                                                        alt="motif-read" class="me-2"
                                                        width="40">{{ $storyMiddle->StoryMiddle->name }}</span> <br>
                                                <span
                                                    class="text-submodal-story">{{ $storyMiddle->StoryMiddle->position }}</span><br><br>
        ...
        <div class="container">
            <div class="row mb-5 justify-content-center">
                @foreach ($storyDown as $storyDowns)
                    <div class="col-sm-12 col-md-6">
                        <a data-bs-toggle="modal" data-bs-target="#storyDown-{{ $storyDowns->StoryDown->id }}"
                            style="cursor: pointer;">
                            <div class="card" data-aos="fade-right">
                                <div class="card-body p-0">
                                    <img src="{{ Storage::url($storyDowns->StoryDown->image_cover) }}" class="img-card-ihd me-3"
                                        alt="..." style="float: left; width: 45%;">
                                    <p class="text-card-story mt-5">
                                        <img src="{{ asset('template/united-nation/assets/images/motif-read-blue.svg') }}"
                                            alt="motif-read" class="me-2"
                                            width="40">{{ $storyDowns->StoryDown->name }}
                                    </p>
                                </div>
                            </div>
                        </a>
                    ...
                    {{-- Modal --}}
                    <div class="modal fade" id="storyDown-{{ $storyDowns->StoryDown->id }}" aria-hidden="true"
                        aria-labelledby="story-1" tabindex="-1">
                        <div class="modal-dialog modal-fullscreen">
                            <div class="modal-content">
                                <div class="modal-body pt-0 pb-0">
                                    <div class="row">
                                        <div class="col-lg-5 p-0">
                                            <img src="{{ Storage::url($storyDowns->StoryDown->image_box) }}"
                                                class="img-responsive me-3" height="100%" width="100%"
                                                alt="...">
                                        </div>
                                        <div class="col-lg-7">
                                            ...
                                            <p class="text-content"
                                                ...
                                                <span class="text-modal-story"><img
                                                        src="{{ asset('template/united-nation/assets/images/motif-read-blue.svg') }}"
                                                        alt="motif-read" class="me-2"
                                                        width="40">{{ $storyDowns->StoryDown->name }}</span> <br>
                                                <span
                                                    class="text-submodal-story">{{ $storyDowns->StoryDown->position }}</span><br><br>
