                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form action="{{ route('story.update', $story->id) }}" class="form form-vertical"
                                                    ...
                                                    <div class="form-group has-icon-left">
                                                        ...
                                                        <div class="position-relative">
                                                            <input type="text"
                                                                ...
                                                                value="{{ old('name', $story->Story->name) }}">
                                                            @error('name')
                                                    ...
                                                    <div class="form-group has-icon-left">
                                                        ...
                                                        <div class="position-relative">
                                                            <input type="text"
                                                                ...
                                                                value="{{ old('position', $story->Story->position) }}">
                                                            @error('position')
                                                                <div class="invalid-feedback">
                                                                    {{ $message }}
                                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="position-relative">
                                                            <textarea type="text" class="form-control @error('description') is-invalid @enderror" cols="10" rows="10"
                                                                placeholder="description" id="description" name="description">{{ old('description', $story->Story->description) }}</textarea>
                                                            @error('description')
                                                                <div class="invalid-feedback">
                                                                    {{ $message }}
                                                                </div>
                                                        ...
                                                        <div class="card shadow-sm p-2 m-0">
                                                            @if ($story->Story->image_cover)
                                                                <img class="img-responsive" id="blah1"
                                                                    src="{{ Storage::url($story->Story->image_cover) }}" />
                                                            @else
                                                                <img class="img-responsive" id="blah1" />
                                                            @endif
                                                        </div>
                                                        ...
                                                        <div class="card shadow-sm p-2 m-0">
                                                            @if ($story->Story->image_box)
                                                                <img class="img-responsive" id="blah2"
                                                                    src="{{ Storage::url($story->Story->image_box) }}" />
                                                            @else
                                                                <img class="img-responsive" id="blah2" />
                                                            @endif
                                                        </div>
