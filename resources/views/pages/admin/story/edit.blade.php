                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="card shadow-sm p-2 m-0">
                                                            @if($story->image_cover)
                                                                <img class="img-responsive" id="blah1" src="{{ Storage::url($story->image_cover) }}"/>
                                                            @else
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" class="form-control @error('image_cover') is-invalid @enderror" placeholder="image_cover" id="imgInp1" name="image_cover" value="{{ old("image_cover", $story->image_cover) }}">
                                                        @error('image_cover')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div>
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="card shadow-sm p-2 m-0">
                                                            @if($story->image_box)
                                                                <img class="img-responsive" id="blah2" src="{{ Storage::url($story->image_box) }}"/>
                                                            @else
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" class="form-control @error('image_box') is-invalid @enderror" placeholder="image_box" id="imgInp2" name="image_box" value="{{ old("image_box", $story->image_box) }}">
                                                        @error('image_box')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div>
