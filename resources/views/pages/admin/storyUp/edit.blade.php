                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form action="{{ route('storyUp.update', $story->id) }}" class="form form-vertical"
                                                    ...
                                                    <div class="form-group has-icon-left">
                                                        ...
                                                        <div class="position-relative">
                                                            <input type="text"
                                                                ...
                                                                value="{{ old('name', $story->StoryUp->name) }}">
                                                            @error('name')
                                                    ...
                                                    <div class="form-group has-icon-left">
                                                        ...
                                                        <div class="position-relative">
                                                            <input type="text"
                                                                ...
                                                                value="{{ old('position', $story->StoryUp->position) }}">
                                                            @error('position')
                                                                <div class="invalid-feedback">
                                                                    {{ $message }}
                                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="position-relative">
                                                            <textarea type="text" class="form-control @error('description') is-invalid @enderror" cols="10" rows="10"
                                                                placeholder="description" id="description" name="description">{{ old('description', $story->StoryUp->description) }}</textarea>
                                                            @error('description')
                                                                <div class="invalid-feedback">
                                                                    {{ $message }}
                                                                </div>
