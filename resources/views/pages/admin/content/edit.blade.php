                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form action="{{ route('content.update', $content->id) }}" class="form form-vertical"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="position-relative">
                                                            <textarea type="text" class="form-control @error('content_1') is-invalid @enderror" cols="10" rows="10"
                                                                placeholder="Create a sentence in this text area..." id="summernote1" name="content_1">{{ old('content_1', $content->Content->content_1) }}</textarea>
                                                            @error('content_1')
                                                                <div class="invalid-feedback">
                                                                    {{ $message }}
                                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="position-relative">
                                                            <textarea type="text" class="form-control @error('content_2') is-invalid @enderror" cols="10" rows="10"
                                                                placeholder="Create a sentence in this text area..." id="summernote2" name="content_2">{{ old('content_2', $content->Content->content_2) }}</textarea>
                                                            @error('content_2')
                                                                <div class="invalid-feedback">
                                                                    {{ $message }}
                                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="position-relative">
                                                            <textarea type="text" class="form-control @error('content_3') is-invalid @enderror" cols="10" rows="10"
                                                                placeholder="Create a sentence in this text area..." id="summernote3" name="content_3">{{ old('content_3', $content->Content->content_3) }}</textarea>
                                                            @error('content_3')
                                                                <div class="invalid-feedback">
                                                                    {{ $message }}
                                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="position-relative">
                                                            <textarea type="text" class="form-control @error('content_4') is-invalid @enderror" cols="10" rows="10"
                                                                placeholder="Create a sentence in this text area..." id="summernote4" name="content_4">{{ old('content_4', $content->Content->content_4) }}</textarea>
                                                            @error('content_4')
                                                                <div class="invalid-feedback">
                                                                    {{ $message }}
                                                                </div>
