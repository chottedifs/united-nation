        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Story Middle</h3>
                    <a href="{{ route('storyMiddle.create') }}" class="btn btn-outline-primary icon-left mt-3 mb-3">Add Story
                        Middle</a>
                </div>
                        ...
                        <tbody>
                            @foreach ($stories as $story)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a href="{{ route('storyMiddle.edit', $story->id) }}"
                                                class="btn btn-outline-warning .icon-left me-2"><i
                                                    class="bi bi-pencil-square"></i></a>
                                            <form onsubmit="return confirm('Are you sure ?');"
                                                action="{{ route('storyMiddle.destroy', $story->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
