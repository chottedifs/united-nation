    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Edit Report Infographics</h3>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Form Edit Report Infographics</h3>
                        </div>
                        <div class="card-content">
                            <div class="card-body">
                                <form action="{{ route('reportInfografis.update', $relasiInfografis->id) }}" class="form form-vertical" method="post" enctype="multipart/form-data">
                                    @method('PUT')
                                    @csrf
                                    <div class="form-body">
                                        <div class="row">
                                                ...
                                                <div class="form-group has-icon-left">
                                                    ...
                                                    <fieldset class="form-group">
                                                        ...
                                                        <select name="report_id" class="form-select" id="basicSelect">
                                                            ...
                                                            @if(old('report_id') == $report->id || $relasiInfografis->Report->id == $report->id)
