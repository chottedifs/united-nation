        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <a href="{{ route('reportInfografis.create') }}" class="btn btn-outline-primary icon-left mt-3 mb-3">Add
                        Report Infographic</a>
                </div>
                        ...
                        <tbody>
                            @foreach ($infografis as $infographics)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a href="{{ route('reportInfografis.edit', $infographics->id) }}"
                                                class="btn btn-outline-warning .icon-left me-2"><i
                                                    class="bi bi-pencil-square"></i></a>
                                            <form onsubmit="return confirm('Are you sure ?');"
                                                action="{{ route('reportInfografis.destroy', $infographics->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
