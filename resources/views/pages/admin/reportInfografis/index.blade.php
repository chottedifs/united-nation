        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <a href="{{ route('reportInfografis.create') }}" class="btn btn-outline-primary icon-left mt-3 mb-3">Add Report Infographic</a>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <form onsubmit="return confirm('Are you sure ?');" action="{{ route('reportInfografis.destroy', $infographics->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
