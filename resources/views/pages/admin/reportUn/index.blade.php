                        ...
                        <tbody>
                            @foreach ($contents as $content)
                                <tr>
                                    ...
                                    <td><img src="{{ $content->ReportUn->image_1 }}" alt="" style="width: 50px;">
                                    </td>
                                    <td>{{ Str::limit($content->ReportUn->content_2, 100) }}</td>
                                    <td><img src="{{ $content->ReportUn->image_2 }}" alt="" style="width: 50px;">
                                    </td>
                                    <td>{{ Str::limit($content->ReportUn->content_3, 100) }}</td>
                                    <td><img src="{{ $content->ReportUn->image_3 }}" alt="" style="width: 50px;">
                                    </td>
                                    <td>{{ Str::limit($content->ReportUn->content_4, 100) }}</td>
                                    <td><img src="{{ $content->ReportUn->image_4 }}" alt="" style="width: 50px;">
                                    </td>
                                    <td>{{ Str::limit($content->ReportUn->content_5, 100) }}</td>
                                    <td><img src="{{ $content->ReportUn->image_5 }}" alt="" style="width: 50px;">
                                    </td>
