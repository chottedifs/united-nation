        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Infographics</h3>
                    <a href="{{ route('infografis.create') }}" class="btn btn-outline-primary icon-left mt-3 mb-3">Add Infographic</a>
                </div>
                    ...
                    <table class="table" id="table1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <a href="{{ route('infografis.edit', $infographics->id) }}" class="btn btn-outline-warning .icon-left me-2"><i class="bi bi-pencil-square"></i></a>
                                        <form onsubmit="return confirm('Are you sure ?');" action="{{ route('infografis.destroy', $infographics->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
