                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form action="{{ route('report.update', $report->id) }}" class="form form-vertical"
                                                    ...
                                                    <div class="form-group has-icon-left">
                                                        ...
                                                        <div class="position-relative">
                                                            <input type="text"
                                                                ...
                                                                value="{{ old('title', $report->Report->title) }}">
                                                            @error('title')
                                                    ...
                                                    <div class="form-group has-icon-left">
                                                        ...
                                                        <div class="position-relative">
                                                            <input type="text"
                                                                ...
                                                                placeholder="slug" id="first-name-icon" name="slug"
                                                                value="{{ old('slug', $report->Report->slug) }}" disabled>
                                                            @error('slug')
                                                                <div class="invalid-feedback">
                                                                    {{ $message }}
                                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="position-relative">
                                                            <textarea type="text" class="form-control @error('description') is-invalid @enderror" cols="10" rows="10"
                                                                placeholder="description" id="description" name="description">{{ old('description', $report->Report->description) }}</textarea>
                                                            @error('description')
                                                                <div class="invalid-feedback">
                                                                    {{ $message }}
                                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="position-relative">
                                                            <input type="hidden" name="oldImage"
                                                                value="{{ $report->Report->image }}">
                                                            <input type="file"
                                                                class="form-control @error('image') is-invalid @enderror"
                                                                placeholder="image" id="imgInp2" name="image"
                                                                value="{{ old('image', $report->Report->image) }}">
                                                            @error('image')
                                                                <div class="invalid-feedback">
                                                                    {{ $message }}
                                                                </div>
