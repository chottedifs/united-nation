            ...
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    <a href="{{ route('dashboard.index') }}"><img
                            src="{{ asset('template/united-nation/assets/images/logo-uncro.svg') }}" alt="Logo"></a>
                </div>
            ...
            <ul class="menu" style="margin-top: 220px">
                <li class="sidebar-item">
                    <form action="{{ route('logout') }}" method="post">
                        @csrf
                        <button type="submit" class="btn sidebar-link"><i
                                class="bi bi-box-arrow-right p"></i><span>Logout</span></button>
                    </form>
                </li>
            </ul>
        </div>
